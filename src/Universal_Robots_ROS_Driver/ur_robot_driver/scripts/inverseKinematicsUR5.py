...
def transformRobotParameter(theta):
	d = [0.1625,0,0,0.1333,0.0997,0.2871]
	a = [0,-0.425,-0.3922,0,0,0]
	alpha = [pi/2,0,0,pi/2,-pi/2,0]
	T = np.eye(4)
	for i in range(6):
		# print("i:",i)
		# thisT=transformDHParameter(a[i],d[i],alpha[i],theta[i])
		# print("T:",thisT)
		# print("x:",thisT[0,3])
		# print("y:",thisT[1,3])
		# print("z:",thisT[2,3])
		# qt = rot2qt(thisT[0:3,0:3])
		# print("qt.x:",qt[0])
		# print("qt.y:",qt[1])
		# print("qt.z:",qt[2])
		# print("qt.w:",qt[3])
...
class InverseKinematicsUR5:
	def __init__(self):
		...
		# Robot DH parameter
		self.d = [0.1625,0,0,0.1333,0.0997,0.2871]
	...
	def findClosestIK(self,forward_kinematics,current_joint_configuration):
		...
		if Q is not None:
			...
			# print("delta_Q_weights",delta_Q_weights)
			if self.debug:
